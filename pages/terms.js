...
const TermsAndConditions = () => {
  return (
    <Container className="bg-stone-50 px-5 py-16 sm:px-8">
      <Head>
        <title>Terms and Conditions | Team New Sun Foundation</title>
      </Head>
      ...
      <p className="mb-4">
        From time to time our website may also include links to other websites. These links are provided for your convenience to provide further information. You may not create a link to our website from another website or document without TEAM NEW SUN FOUNDATION’s prior written consent.
      </p>
