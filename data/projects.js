export const projectDetails = {
    ...
    'sampreeti': {
        ...
        content: [
            {
                section: "Introduction",
                text: "We initiated the program 'Sampreeti' to celebrate our Independence Day with a cultural event, combining it with our annual cultural program. In 2020, despite the onset of the COVID-19 pandemic across the country, we proceeded with a fully virtual event on YouTube. Despite the pandemic and online format, we received a tremendous response from our audience."
            },
            {
                section: "2021",
                text: "In 2021, we continued with the program in the same virtual format. In 2022, we introduced an innovative online drawing and photography competition, which garnered significant participation. Trophies, certificates, and medals were awarded to the top three participants in both categories."
            },
            {
                section: "Expansion Plans",
                text: "By March 2023, we had successfully completed two major projects along with various others. Encouraged by this, we planned to scale up 'Sampreeti' and decided to host the 2023 edition offline in a public auditorium. This venue allowed our audience to experience the events live."
            },
            {
                section: "Drawing Competition",
                text: "Additionally, we organized an offline drawing competition, held on ___ at Anandam School, Belgharia. The overwhelming response exceeded our expectations. Following the competition, light refreshments were provided for the participants. We planned to distribute prizes to the winners during the main cultural program on August 13, 2023."
            },
            {
                section: "Main Cultural Event",
                text: "On August 13, 2023, the inaugural offline cultural event took place in front of our audience. To commence the program, we invited the respected Swami Attanathananda Maharaj. The event featured various performances including dance, recitations, music, and drama. We also presented awards to the winners of the offline drawing competition. The program concluded with a collective rendition of the national anthem, creating a beautiful atmosphere."
            }
        ],
        href: "sampreeti"
    },
    'sobujersondhane': {
        image: ["https://res.cloudinary.com/dcikuo4sk/image/upload/v1708797707/samples/New-Sun-Projects/Copy_of_DND_3800_1_glbdk3.jpg",
            "https://res.cloudinary.com/dcikuo4sk/image/upload/v1718888129/Sobujer%20Sondhane/WhatsApp_Image_2024-06-20_at_18.18.26_2_iep6nn.jpg",
            "https://res.cloudinary.com/dcikuo4sk/image/upload/v1718888128/Sobujer%20Sondhane/FB_IMG_1682615958049_cjjwem.jpg",
            "https://res.cloudinary.com/dcikuo4sk/image/upload/v1718888127/Sobujer%20Sondhane/IMG-20230604-WA0059_jf5jt2.jpg",
            "https://res.cloudinary.com/dcikuo4sk/image/upload/v1718888127/Sobujer%20Sondhane/FB_IMG_1682615940823_okgecr.jpg",
            "https://res.cloudinary.com/dcikuo4sk/image/upload/v1718888126/Sobujer%20Sondhane/IMG-20230604-WA0123_c4dbgf.jpg",
            "https://res.cloudinary.com/dcikuo4sk/image/upload/v1718888124/Sobujer%20Sondhane/FB_IMG_1682616014843_lkqd9m.jpg",
        ...
        content: [
            {
                "section": "Introduction",
                "text": "Trees are an integral part of our lives, providing essential benefits to the environment and our well-being. Unfortunately, rapid urbanization and development have led to widespread deforestation, causing significant environmental challenges. As representatives of society, it is our responsibility to take action to mitigate these effects. Even small efforts can make a significant difference and inspire others to join the cause. To address this, TEAM NEW SUN FOUNDATION has organized an annual tree plantation drive on World Environment Day, starting in 2022. Our initiative aims to combat deforestation and promote environmental sustainability."
            },
            {
            ...
            },
            {
                ...
                "text": "In 2023, our event was held at the Birati Nabadarsha Co-operative Society. The initiative received enthusiastic support from the society's residents. Trees were planted at various locations within the society, and children from the neighborhood participated, fostering a sense of environmental responsibility from a young age."
            },
            {
