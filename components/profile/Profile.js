...
const Profile = ({ user, id, due }) => {
    return (
        <div className="sm:w-2/3 lg:w-1/2 bg-white rounded-md shadow-md my-2 mx-5">
            <div className='px-8 py-6'>
                <ProfileImage value={user.image.url} fieldName="image" gender={user.sex} id={id} />
                ...
                <div className="flex flex-wrap">
                    <div className="w-full sm:w-1/2">
                        <ProfileFields value={due} label="Due" dataType="Number" editAble={false} id={id} fieldName="due" />
                    </div>
                    <div className="w-full sm:w-1/2">
