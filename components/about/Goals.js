...
const Goals = () => {
    return (
        <div className="w-full bg-gradient-to-br from-slate-700 to-slate-800 py-10 px-6 md:px-16">
            ...
            <ol className="text-lg text-gray-200 space-y-4">
                ...
                <li className="flex items-center">
                    <CheckCircleIcon className="h-6 w-6 text-yellow-500 mr-3" />
                ...
                <li className="flex items-center">
                    <CheckCircleIcon className="h-6 w-6 text-teal-500 mr-3" />
                ...
                <li className="flex items-center">
                    <CheckCircleIcon className="h-6 w-6 text-purple-500 mr-3" />
