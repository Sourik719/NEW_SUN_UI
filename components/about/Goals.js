        ...
        <div className="w-full bg-gradient-to-br from-slate-700 to-slate-800 py-10 px-6 md:px-16 flex flex-col items-center justify-center">
            ...
            <ol className="text-lg text-gray-200 space-y-6">
                <li className="flex items-center">
                    ...
                    <span className="font-semibold mr-1">Equal Education: </span> Ensuring every child has access to quality learning opportunities.
                </li>
                <li className="flex items-center">
                    <CheckCircleIcon className="h-6 w-6 text-blue-500 mr-4" />
                    <span className="font-semibold mr-1">Social Awareness: </span> Raising understanding and empathy for diverse social challenges.
                </li>
                <li className="flex items-center">
                    <CheckCircleIcon className="h-6 w-6 text-yellow-500 mr-4" />
                    <span className="font-semibold mr-1">Financial Empowerment: </span> Providing crucial support to individuals facing economic hardship.
                </li>
                <li className="flex items-center">
                    <CheckCircleIcon className="h-6 w-6 text-teal-500 mr-4" />
                    <span className="font-semibold mr-1">Environmental Stewardship: </span> Actively protecting and preserving our planet for future generations.
                </li>
                <li className="flex items-center">
                    <CheckCircleIcon className="h-6 w-6 text-purple-500 mr-4" />
                    <span className="font-semibold mr-1">Cultural Harmony: </span> Fostering inclusive environments that celebrate and respect all cultures.
                </li>
            </ol>
        </div>
    );
